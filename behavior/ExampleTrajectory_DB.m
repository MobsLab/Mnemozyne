...
axes(PreTest_Axes)
[p_occ,h_occ, her_occ] = PlotErrorBarN_DB([Pre_Occup_Shock_mean*100 Pre_Occup_Safe_mean*100], 'barcolors', [1 0 0], 'barwidth', 0.6, 'newfig', 0, 'showpoints',0);
...
axes(Cond_Axes)
[p_occ,h_occ, her_occ] = PlotErrorBarN_DB([Cond_Occup_Shock_mean*100 Cond_Occup_Safe_mean*100], 'barcolors', [1 0 0], 'barwidth', 0.6, 'newfig', 0, 'showpoints',0);
h_occ.FaceColor = 'flat';
h_occ.CData(2,:) = [0 0 1];
set(gca, 'FontSize', 18, 'FontWeight',  'bold','FontName','Times New Roman');
...
axes(PostTest_Axes)
[p_occ,h_occ, her_occ] = PlotErrorBarN_DB([Post_Occup_Shock_mean*100 Post_Occup_Safe_mean*100], 'barcolors', [1 0 0], 'barwidth', 0.6, 'newfig', 0, 'showpoints',0);
h_occ.FaceColor = 'flat';
h_occ.CData(2,:) = [0 0 1];
set(gca, 'FontSize', 18, 'FontWeight',  'bold','FontName','Times New Roman');
set(gca, 'LineWidth', 5,'Xtick',[1:2],'XTickLabel',{'Shock','Safe'},'YTickLabel',{});
